...
hi Comment  guifg=#008220 guibg=#000000 gui=none ctermfg=022 cterm=none
hi Constant  guifg=#1fc700 guibg=#001c00 gui=none ctermfg=044 cterm=none
hi Cursor  guifg=#00ff00 gui=bold,reverse ctermfg=010 ctermbg=000 cterm=bold,reverse
hi CursorLine guifg=#000000 guibg=#00cc00 gui=none ctermfg=none ctermbg=none cterm=underline
...
hi DiffAdd  guifg=#00bf00 guibg=#002200 gui=none ctermfg=034 cterm=none
hi DiffChange  guifg=#00a900 guibg=#002200 gui=none ctermfg=040 cterm=none
hi DiffDelete  guifg=#000000 guibg=#005500 gui=none ctermfg=002 cterm=none
hi DiffText  guifg=#00aa00 guibg=#004400 gui=underline ctermfg=028 cterm=none
hi Directory  guifg=#009330 guibg=#000000 gui=none ctermfg=022 cterm=none
hi Error  guifg=#000000 guibg=#00d000 gui=none ctermfg=000 ctermbg=010 cterm=none
hi ErrorMsg  guifg=#000000 guibg=#00ff00 gui=bold ctermfg=000 cterm=none
...
hi Identifier  guifg=#50d930 guibg=#000000 gui=none ctermfg=028 cterm=none
hi IncSearch  gui=reverse ctermfg=000 ctermbg=255 cterm=none
...
hi ModeMsg  guifg=#00ea00 guibg=#000900 gui=none ctermfg=002 cterm=none
hi MoreMsg  guifg=#00e700 guibg=#001000 gui=bold ctermfg=002 cterm=bold
hi NonText  guifg=#008700 guibg=#001000 gui=none ctermfg=022 cterm=none
hi Normal  guifg=#00a900 guibg=#000000 gui=none ctermfg=002 cterm=none
...
hi PreProc  guifg=#00ac5c guibg=#000000 gui=none ctermfg=047 cterm=none
...
hi Type   guifg=#1fb631 guibg=#000000 gui=none ctermfg=012 cterm=none
hi Underlined  guifg=#00b400 guibg=#000000 gui=underline ctermfg=002 cterm=underline
